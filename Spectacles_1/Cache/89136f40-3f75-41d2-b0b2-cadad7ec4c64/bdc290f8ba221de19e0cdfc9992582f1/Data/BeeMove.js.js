...
var body = beeSceneObject.getComponent('Physics.BodyComponent')
...
//var awakeEvent = script.createEvent('OnAwakeEvent');
//awakeEvent.bind(function (_) {
//    print("Component is awake now");
    
//    beeSceneObject.getComponent('Physics.BodyComponent').onCollisionEnter(function (eventArgs) {
//        print('Bee collides, to disable visibility')
//       beeSceneObject.enabled = false; 
//    });
//});
