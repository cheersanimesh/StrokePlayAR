...
//var body = beeSceneObject.createComponent('Physics.BodyComponent');
...
event.bind(function (eventData) {
    ...
    // Print the bee's position for debugging
//    print("Bee Position: " + pos.z);
    
    var camCoords = cameraObject.getTransform().getWorldPosition();
//    print(camCoords)
    if (camCoords.x == pos.x && camCoords.y == pos.y && camCoords.z == pos.z) {
        camera_Count += 1;        
        print("FFFFFFFFF: Failed")
        return ;
    }
    ...
    if (pos.z > 40) {
        ...
        //print("Bee object reset to initial position. Turn count: " + turnCounter + "\nCoint: " + camera_Count);
    }
